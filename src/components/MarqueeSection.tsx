...
const MarqueeSection: React.FC = () => {
  ...
  // Duplicate arrays for seamless loop - More duplicates for smoother scrolling
  const duplicatedMentors = [...mentorImages, ...mentorImages, ...mentorImages, ...mentorImages, ...mentorImages, ...mentorImages  , ...mentorImages];
  const duplicatedCompanies = [...companyLogos, ...companyLogos, ...companyLogos, ...companyLogos];
  const duplicatedColleges = [
    ...collegeLogos,
    ...collegeLogos,
    ...collegeLogos,
    ...collegeLogos,
    ...
    ...collegeLogos,
    ...collegeLogos,
  ]; // Even more duplicates for ultra smooth loop
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      ...
      <div className="w-full space-y-8">
        ...
        <div className="relative w-full">
          <h3 className="text-xl font-semibold text-gray-800 mb-4 text-center">Hiring Partners</h3>
          <div className="w-full overflow-hidden">
