        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/free-test" className="text-gray-400 hover:text-white transition-colors">
                  Take Free Test
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4 text-sm">
              MinuteHire is a next-gen minute hiring and advanced HRMS platform that helps companies
              streamline recruitment, testing, onboarding, and employee management — all in one
              place.
            </p>
            <Link
              to="/about"
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-start">
                <svg
                  className="h-4 w-4 text-gray-400 mr-3 mt-1"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <span className="text-gray-400">
                  49/26, Sahibabad, Ghaziabad, Uttar Pradesh 201010
                </span>
              </div>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-4 mb-4 md:mb-0">
            <div className="flex items-center space-x-3">
              <img src="/Logo.png" alt="MinuteHire Logo" className="h-8 w-auto" />
              <span className="text-xl font-bold">MinuteHire</span>
            </div>
            <p className="text-gray-400 text-sm">© 2024 MinuteHire. All rights reserved.</p>
          </div>
