...
const PayrollPage = () => {
  ...
  const handleGeneratePayslip = (employeeId: number) => {
    toast({
      ...
      description: "Payslip has been generated successfully and sent to employee.",
    });
  };

  const handleDownloadPayslip = (employeeId: number) => {
    toast({
      title: "Download Started",
      description: "Payslip PDF download has started.",
    });
  };
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-green-600">₹{(payrollSummary.totalPayroll / 1000000).toFixed(1)}M</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-purple-600">₹{payrollSummary.avgSalary.toLocaleString()}</p>
            </div>
          </CardContent>
        </Card>
      </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-green-600">+₹{emp.allowances.toLocaleString()}</p>
                      </div>
                      <div>
                        <p className="text-gray-600">Deductions</p>
                        <p className="font-medium text-red-600">-₹{emp.deductions.toLocaleString()}</p>
                      </div>
                      <div>
