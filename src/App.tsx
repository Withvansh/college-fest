...
import { RoleToggleProvider } from './contexts/RoleToggleContext';
              ...
              <RoleToggleProvider>
                <div className="min-h-screen w-full">
                  ...
                  <Routes>
                    ...
                    <Route path="/super-admin-access" element={<AdminAccess />} />
                    <Route path="/super-admin/login" element={<AdminLogin />} />
                    <Route
                      path="/super-admin/*"
                      element={
                        <UnifiedProtectedRoute allowedRoles={['admin', 'super_admin']}>
                          <AdminLayout />
                        </UnifiedProtectedRoute>
                      }
                    >
