...
const Pricing = () => {
  ...
  const comparisonFeatures = [
    { name: "Create Profile", free: true, pro: true, campus: true, corporate: true, freelancer: true },
    { name: "Job/Gig Applications", free: "Limited", pro: "Unlimited", campus: "–", corporate: "–", freelancer: "Unlimited" },
    { name: "AI Tests & Feedback", free: false, pro: true, campus: true, corporate: true, freelancer: true },
    { name: "Dedicated Support", free: false, pro: false, campus: true, corporate: true, freelancer: true },
    { name: "Custom Branding", free: false, pro: false, campus: true, corporate: true, freelancer: false },
    { name: "Analytics Dashboard", free: false, pro: true, campus: true, corporate: true, freelancer: true }
  ];

  const faqs = [
    {
      question: "Can I upgrade anytime?",
      answer: "Yes, you can upgrade your plan at any time. The changes will be reflected immediately in your account."
    },
    {
    ...
    },
    {
      ...
      answer: "Campus+ and Enterprise plans include dedicated onboarding support and training sessions."
    },
    {
      question: "How does billing work for teams?",
      answer: "Team plans are billed monthly or annually. You can add or remove team members anytime."
    },
    {
      question: "What payment methods do you accept?",
      answer: "We accept all major credit cards, UPI, net banking, and bank transfers for enterprise plans."
    }
  ];
      ...
      <section className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 leading-tight">
            Pricing That <span className="bg-gradient-to-r from-yellow-300 to-orange-400 bg-clip-text text-transparent">Scales</span>
            <br />
            With Your Success
          </h1>
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto leading-relaxed">
            Whether you're just starting out or scaling rapidly, we have the perfect plan to accelerate your hiring journey and career growth.
          </p>
          
          {/* Billing Toggle */}
          <div className="flex items-center justify-center space-x-4 mb-12">
            <span className={`font-semibold text-lg ${!isYearly ? 'text-white' : 'text-blue-200'}`}>Monthly</span>
            <Toggle
              pressed={isYearly}
            ...
            <span className={`font-semibold text-lg ${isYearly ? 'text-white' : 'text-blue-200'}`}>
              Yearly <Badge className="ml-2 bg-gradient-to-r from-green-400 to-emerald-500 text-white border-0">Save 17%</Badge>
            </span>
          </div>

          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Button size="lg" className="bg-white text-blue-600 hover:bg-blue-50 px-8 py-4 text-lg font-bold rounded-xl shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300">
              Compare All Plans
            </Button>
            <Button size="lg" variant="outline" className="border-2 border-white/80 text-white hover:bg-white hover:text-blue-600 px-8 py-4 text-lg font-bold rounded-xl backdrop-blur-sm shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300">
              Start Free Trial
            </Button>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Enhance your experience with these premium features</p>
          </div>
                  ...
                  <tr key={index} className="border-b">
                    ...
                    <td className="text-center p-4">
                      {typeof feature.campus === 'boolean' ? (
                        feature.campus ? <Check className="h-5 w-5 text-green-500 mx-auto" /> : '❌'
                      ) : feature.campus}
                    </td>
                    <td className="text-center p-4">
                      {typeof feature.corporate === 'boolean' ? (
                        feature.corporate ? <Check className="h-5 w-5 text-green-500 mx-auto" /> : '❌'
                      ) : feature.corporate}
                    </td>
                    <td className="text-center p-4">
                      {typeof feature.freelancer === 'boolean' ? (
                        feature.freelancer ? <Check className="h-5 w-5 text-green-500 mx-auto" /> : '❌'
                      ) : feature.freelancer}
                    </td>
                  </tr>
                ))}
