...
const Companies = () => {
  ...
  const [inviteData, setInviteData] = useState({
    ...
    message:
      'We would like to invite your company to participate in our campus recruitment program.',
  });
        ...
        <div className="container mx-auto px-4 sm:px-6 py-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <h1 className="text-lg sm:text-2xl font-bold text-gray-900">Company Management</h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="w-full lg:w-1/3 order-2 lg:order-1">
            <Card className="h-full">
              ...
              <CardContent className="p-0">
                <div className="h-[300px] lg:h-[calc(100vh-250px)] overflow-y-auto">
                          ...
                          <div className="mt-2 sm:mt-3 flex items-center justify-between">
                            ...
                            <Link to={`/college/company/${company._id}`}>
                              <Button
                                size="sm"
                                variant="outline"
                                className="text-xs h-6 px-2 sm:h-9 sm:text-sm sm:px-4"
                              >
          ...
          <div className="w-full lg:w-2/3 order-1 lg:order-2">
            <Card className="h-full">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                    <Dialog open={isInviteModalOpen} onOpenChange={setIsInviteModalOpen}>
                      <DialogTrigger asChild>
                        <Button className="bg-orange-600 hover:bg-orange-700 text-xs sm:text-sm h-8 sm:h-10 w-full sm:w-auto">
                          <Send className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2" />
                          Invite Company
                        </Button>
                      </DialogTrigger>
                      <DialogContent className="max-w-sm sm:max-w-md lg:max-w-lg mx-auto w-[calc(100vw-1.5rem)] sm:w-[calc(100vw-2rem)] lg:w-auto max-h-[90vh] overflow-y-auto">
                        <DialogHeader className="pb-3 sm:pb-4">
                          <DialogTitle className="text-base sm:text-lg lg:text-xl">
                            Invite a Company
                          </DialogTitle>
                        </DialogHeader>
                        <form onSubmit={handleInviteCompany} className="space-y-3 sm:space-y-4">
                          ...
                          <div className="space-y-1">
                            ...
                            <Input
                              ...
                              onChange={e =>
                                setInviteData({ ...inviteData, contactEmail: e.target.value })
                              }
                          ...
                          <div className="space-y-1">
                            <Label htmlFor="jobRole" className="text-sm sm:text-base">
                              Job Role
                            </Label>
                            <Input
                              id="jobRole"
                              ...
                              onChange={e =>
                                setInviteData({ ...inviteData, jobRole: e.target.value })
                              }
                          ...
                          <div className="space-y-1">
                            <Label htmlFor="driveDate" className="text-sm sm:text-base">
                              Drive Date
                            </Label>
                            <Input
                              id="driveDate"
                              ...
                              onChange={e =>
                                setInviteData({ ...inviteData, driveDate: e.target.value })
                              }
                              required
                              className="h-9 sm:h-10 text-sm sm:text-base"
                            />
                          ...
                          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-end pt-2 sm:pt-3">
                            <Button
                              type="button"
                              variant="outline"
                    ...
                    <Link to={'/college/company/invites'}>
                      <Button className="bg-orange-600 hover:bg-orange-700 text-xs sm:text-sm h-8 sm:h-10 w-full sm:w-auto">
              ...
              <CardContent>
                ...
                <div className="h-[300px] lg:h-[calc(100vh-450px)] overflow-y-auto">
                  {/* Desktop Table View */}
                      ...
                      <Card key={company._id} className="p-4">
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              <h3 className="font-semibold text-base">{company.company_name}</h3>
                              <Badge variant="secondary" className="mt-1 text-xs">
                                {company.industry || 'Not specified'}
                              </Badge>
                            </div>
                        ...
                        <div className="space-y-2 mb-4">
                          <div>
                            ...
                            <div className="font-medium text-sm">{company.full_name}</div>
                          </div>
                          <div>
                            <div className="text-gray-500 text-xs uppercase tracking-wide">
                              Email
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                          <Link to={`/college/company/${company._id}`} className="flex-1">
