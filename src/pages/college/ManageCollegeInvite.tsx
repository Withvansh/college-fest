    ...
    try {
      ...
      if (response.data.success) {
        setInvites(invites.map(invite => 
          invite._id === id ? { ...invite, status } : invite
        ));
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Manage College Invites</h1>
          <p className="text-gray-600 mt-2">View and manage all company invites for your college</p>
        </div>
<Link to={"/college/companies"}> <div className='flex justify-evenly w-24'><ArrowLeft/> <p>Go back</p></div>  </Link>
        {error && (
                    ...
                    <tr key={invite._id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <div className="text-sm font-medium text-gray-900">{invite.companyName}</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="col-span-2">
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <div className="ml-4">
                        <div className="text-lg font-medium text-gray-900">{selectedInvite.companyName}</div>
                        <div className="text-sm text-gray-500">
                          Contact: {selectedInvite.originalData.recruiter_id?.full_name || 'Unknown'}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(selectedInvite.status)}`}>
                  ...
                  {selectedInvite.message && (
                    <div className="col-span-2">
                      ...
                      <p className="mt-1 text-sm text-gray-900">{selectedInvite.message}</p>
                    </div>
                  )}
                  
                  {selectedInvite.students && selectedInvite.students.length > 0 && (
                    <div className="col-span-2">
                      <label className="block text-sm font-medium text-gray-700">Targeted Students</label>
