    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="text-center mb-8 md:mb-12">
          <Link to="/" className="flex items-center justify-center space-x-3 mb-4 md:mb-6 hover:opacity-80 transition-opacity">
            <img 
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-gray-900 mb-2 md:mb-4 px-4">Access Admin Dashboard</h1>
          <p className="text-base md:text-xl text-gray-600 px-4">Choose your admin access level to continue</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 px-4">
          ...
          <Card className="hover:shadow-2xl transition-all duration-300 hover:scale-105 border-2 hover:border-blue-500">
            <CardHeader className="text-center pb-3 md:pb-4">
              ...
              <CardTitle className="text-xl md:text-2xl font-bold text-gray-900">Super Admin</CardTitle>
              <p className="text-gray-600 text-sm md:text-base">Full platform control and management</p>
            </CardHeader>
          ...
          <Card className="hover:shadow-2xl transition-all duration-300 hover:scale-105 border-2 hover:border-purple-500">
            <CardHeader className="text-center pb-3 md:pb-4">
              ...
              <CardTitle className="text-xl md:text-2xl font-bold text-gray-900">HR Admin</CardTitle>
        ...
        <div className="text-center mt-6 md:mt-8">
          <Link to="/">
            <Button variant="ghost" className="text-gray-600 hover:text-gray-800 text-sm md:text-base">
              ← Back to Home
            </Button>
          </Link>
        </div>
