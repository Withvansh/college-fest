    ...
    return (
      <div className="min-h-screen bg-gray-50 py-4 md:py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <button
            onClick={goBack}
            className="flex items-center text-blue-600 hover:text-blue-800 mb-4 sm:mb-6 transition-colors text-sm md:text-base"
          >
            <svg
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 line-clamp-2">
                {job?.title}
              </h1>
              <p className="text-gray-600 mt-1 text-sm sm:text-base">{job?.company_name}</p>
            </div>
          </div>
          <div className="bg-blue-50 text-blue-700 px-3 sm:px-4 py-2 rounded-md text-sm sm:text-base font-medium">
            <span className="font-semibold">{applicants.length}</span> applicant
            {applicants.length !== 1 ? 's' : ''}
          </div>
        </div>

        {applicants.length === 0 && !loading ? (
          <div className="bg-blue-50 border border-blue-200 text-blue-700 px-4 sm:px-6 py-4 sm:py-5 rounded-lg">
            <div className="flex items-center">
              <svg
          ...
          <>
                ...
                <div key={applicant._id} className="bg-white shadow-md rounded-lg p-4">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-12 w-12 mr-3">
                        {applicant.applicant_id.profile_picture ? (
                          <img
                            ...
                            src={applicant.applicant_id.profile_picture}
                            alt=""
                          />
                        ) : (
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{applicant.applicant_id.email}</p>
                        {applicant.applicant_id.phone && (
                          <p className="text-sm text-gray-500">{applicant.applicant_id.phone}</p>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                    <div>
                      ...
                      <p className="text-gray-600">{formatDate(applicant.applied_at)}</p>
                    </div>
                    <div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <select
                      ...
                      onChange={e =>
                        handleStatusChange(applicant._id, e.target.value as ApplicationStatus)
                      }
            ...
            {showModal && selectedApplicant && (
              <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center z-50 px-4 py-4">
                <div className="relative bg-white rounded-lg shadow-xl max-w-4xl w-full mx-auto max-h-[90vh] overflow-y-auto">
                  <div className="sticky top-0 bg-white border-b px-4 sm:px-6 py-4 flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="text-gray-400 hover:text-gray-600 rounded-full p-1 hover:bg-gray-100 transition-colors flex-shrink-0"
                    >
                      <svg
                  ...
                  <div className="p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row items-start mb-6 gap-4">
                      ...
                      <div className="flex-grow text-center sm:text-left">
                        <h2 className="text-xl sm:text-2xl font-bold text-gray-800">
                          {selectedApplicant.applicant_id.full_name}
                        </h2>
                        <p className="text-gray-600 text-sm sm:text-base">
                          {selectedApplicant.applicant_id.email}
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6">
                      <div className="bg-gray-50 p-4 rounded-lg">
                        <h4 className="text-base sm:text-lg font-semibold mb-3 text-gray-800 border-b pb-2">
                          Application Details
                        </h4>
                      ...
                      <div className="mb-6 bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="space-y-2">
                          <p>
                            ...
                            {formatDate(selectedApplicant.interview_date)}
                          </p>
                    ...
                    <div className="flex flex-col-reverse sm:flex-row sm:justify-between sm:items-center mt-6 pt-4 border-t gap-4">
                      <select
